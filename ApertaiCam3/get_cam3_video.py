...
BUFFER_PATH = f"/home/{USER}/Desktop/ApertaiRemoteClone/ApertaiCam3"
...
def save_last_30_seconds_from_buffer():
    ...
    input_file_1 = os.path.join(BUFFER_PATH, 'cam-3-buffer-1-000.ts')
    input_file_2 = os.path.join(BUFFER_PATH, 'cam-3-buffer-2-000.ts')
