...
CITY = "belohorizonte"
COURT = "duna"
RTSP_URL = "rtsp://apertaiCam3:130355va@10.0.0.123/stream1"
...
def start_buffer_stream_1():
    ...
    buffer_command = [
        ...
        'cam-3-buffer-1-%03d.ts'  # Save segments with a numbering pattern
    ]
...
def start_buffer_stream_2():
    ...
    buffer_command = [
        ...
        '-segment_wrap', '1',  # Number of segments to wrap around
        '-reset_timestamps', '1',  # Reset timestamps at the start of each segment
        'cam-3-buffer-2-%03d.ts'  # Save segments with a numbering pattern
    ]
    return subprocess.Popen(buffer_command, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
def main():
    ...
    print("Press '1' to save the last 30 seconds of video...")
